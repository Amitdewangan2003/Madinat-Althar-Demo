(function () {
  ...
  var tabData = [
    {
      title: "Active Order #A102-4852",
      route: "Jebel Ali Port → Riyadh Distribution Center",
      badge: "In Transit",
      side: "Every shipment, warehouse bin and customs status updates live as it moves across the network.",
    },
    {
      title: "Shipment #GCC-7734",
      route: "Dubai Warehouse → Doha Port Terminal",
      badge: "Customs Cleared",
      side: "Track each container by GPS checkpoint with automatic alerts at every border crossing.",
    },
    {
      title: "Inventory Sync #WH-2291",
      route: "Dubai Bay 4 → Cross-Dock Staging",
      badge: "Reconciled",
      side: "Warehouse counts reconcile automatically against dispatch and incoming purchase orders.",
    },
  ];
